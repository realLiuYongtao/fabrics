...
class Net(nn.Module):
    def __init__(self):
        ...
        self.self_attention = SelfAttention(128)  # 添加自注意力
...
# 保存模型参数
torch.save(model.state_dict(), './Att2.pth')
